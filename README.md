...
- Their obfuscation process inlined some functions, we can identify and restore them _carefully_ but keep in mind if the deob process is re-ran, it won't capture that work.
...
- The deobfuscation process may _overly_ split variables so if you see.
