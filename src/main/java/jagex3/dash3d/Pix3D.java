...
public class Pix3D extends Pix2D {
	...
	public static final void textureTriangle(int screen_x0, int screen_x1, int screen_x2, int screen_y0, int screen_y1, int screen_y2, int color_a, int color_b, int color_c, int ortho_xp, int ortho_xm, int ortho_xn, int ortho_yp, int ortho_ym, int ortho_yn, int ortho_zp, int ortho_zm, int ortho_zn, int texture) {
		...
		int nvecn_x = ortho_xn - ortho_xp;
		int nvecn_y = ortho_yn - ortho_yp;
		int nvecn_z = ortho_zn - ortho_zp;
		int pxn_zhat = ortho_yp * nvecn_x - ortho_xp * nvecn_y << 14;
		int pxn_xhat = ortho_zp * nvecn_y - ortho_yp * nvecn_z << 8;
		int pxn_yhat = ortho_xp * nvecn_z - ortho_zp * nvecn_x << 5;
		int pxm_zhat = ortho_yp * vecm_x - ortho_xp * vecm_y << 14;
		int pxm_xhat = ortho_zp * vecm_y - ortho_yp * vecm_z << 8;
		int pxm_yhat = ortho_xp * vecm_z - ortho_zp * vecm_x << 5;
